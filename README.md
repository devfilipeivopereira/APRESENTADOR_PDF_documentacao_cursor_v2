...
- **Controle remoto** (`/remote`) – uso em celular/tablet, setas e Espaço no teclado; grade de miniaturas 16:9 (largura exata, sem cortar); em mobile o header mostra só ícones (tela cheia, página inicial, slides, conexão)
